...
export async function getMyDriverPerformanceMetrics() {
  const response = await httpGet<ApiResponse<DriverPerformanceMetrics>>('/api/drivers/me/metrics')
  return response.data
}
